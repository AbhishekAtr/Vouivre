<section class="header white">
    <div class="container header_desgin">
        <nav class="navbar navbar-expand-md ">
            <a class="navbar-brand" href="index"><img src="image/logo.png" alt="Logo"></a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <div class="btn btn_enquiry text-uppercase" data-toggle="modal" data-target="#modals">Enquire Now</div>
                    </li>
                </ul>
            </div>
        </nav>
